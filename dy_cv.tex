...
{\begin{center} \textcolor{gray}{\footnotesize \textit{Research Themes: \textbf{Bayesian Machine Learning, Explainable AI, Scientific applications of Machine Learning}}}\end{center}}
% \newline{}
...
\cventry{2021-}{Postdoctoral Research Associate}{Kavli Institute for Cosmology}{University of Cambridge}{Cambridge}{
  \begin{itemize}
    \item Primary project -- developing novel Bayesian Neural Network methodologies, targeting explainable AI.
    ...
    \item Initially funded through an STFC Industry Partnership Scheme, working with a Cambridge Astrophysics spin-out company on developing next generation AI tools for industrial challenges.
  \end{itemize}
}
...
\section{Grants}
\cventry{2017}{Marie Curie short term Early Stage Researcher grant}{$\sim\textsterling30$k}{}{}{Fully funded Marie Curie visiting position at KIT for 5 months.}
...
\cventry{2022-}{Namu Kroupa}{University of Cambridge}{Part III Natural Sciences project}{}{Marginalised Gaussian Processes for Cosmology}

\cventry{2022-}{Boris Deletic}{University of Cambridge}{Part III Natural Sciences project}{co-supervised w. Dr. Will Barker}{Modified gravity on the lattice}
